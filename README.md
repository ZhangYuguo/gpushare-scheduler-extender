...
[![CircleCI](https://circleci.com/gh/zhangyuguo/gpushare-scheduler-extender.svg?style=svg)](https://circleci.com/gh/zhangyuguo/gpushare-scheduler-extender)
[![Build Status](https://travis-ci.org/zhangyuguo/gpushare-scheduler-extender.svg?branch=master)](https://travis-ci.org/zhangyuguo/gpushare-scheduler-extender) 
[![Go Report Card](https://goreportcard.com/badge/github.com/zhangyuguo/gpushare-scheduler-extender)](https://goreportcard.com/report/github.com/zhangyuguo/gpushare-scheduler-extender)
...
```bash
git clone https://github.com/zhangyuguo/gpushare-scheduler-extender.git && cd gpushare-scheduler-extender
...
```bash
git clone https://github.com/zhangyuguo/gpushare-device-plugin.git && cd gpushare-device-plugin
...
```bash
mkdir -p $GOPATH/src/github.com/zhangyuguo
cd $GOPATH/src/github.com/zhangyuguo
git clone https://github.com/zhangyuguo/gpushare-device-plugin.git
...
- [gpushare device plugin](https://github.com/zhangyuguo/gpushare-device-plugin.git)
